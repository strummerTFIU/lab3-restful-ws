...
public class AddressBookServiceTest {
	...
	public void serviceIsAlive() throws IOException {
		...
		// Tests that it's idempotent.
		assertEquals(response.getStatus(), response2.getStatus());

		// Tests that the address book doesn't change.
	...
	public void createUser() throws IOException {
		...
		// Tests that it isn't idempotent.
		assertNotEquals(response2.getStatus(), response.getStatus());

		// Tests that it isn't safe (AddressBook changed and now it has 2 contacts)
	...
	public void listUsers() throws IOException {
		...
		// Tests that it's safe
		addressBookRetrieved = response2.readEntity(AddressBook.class);
		assertEquals(2, addressBookRetrieved.getPersonList().size());
		assertEquals(juan.getName(), addressBookRetrieved.getPersonList()
				.get(1).getName());
	}
